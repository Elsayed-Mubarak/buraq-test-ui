    ...
    <div>
      ...
      <div className="m-auto max-w-[2050px]">
        <div className="overflow-hidden pt-[10px] xl:pt-[69px]">
          <div className="flex h-auto w-full flex-col items-center justify-between bg-transparent px-5 md:h-[568px] md:flex-row md:bg-[#F8F9FD] md:px-0 md:pl-[77px] xl:h-[925px] xl:pl-[146px]">
