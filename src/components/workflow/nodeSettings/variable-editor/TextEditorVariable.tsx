...
interface DropdownEditorProps {
    ...
    // onChangeFallback: (...props: any[]) => void;
}

export default function TextEditorVariable({
    value = "",
    showToolbar = false,
    onChange,
    className,
    ...
    return (
        <>
            <div className={`relative w-full border rounded-lg bg-white ${asChild ? "mx-0" : "mx-auto max-w-sm"}`}>
                ...
                <div className={`px-4 py-3 min-h-[80px] text-gray-700 relative w-full overflow-y-auto ${className}`}>
                    <Editor
